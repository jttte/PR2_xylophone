...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pickup_object' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cl3295/robot-test/install/${idir}'.  Ask the maintainer 'jvarley <jvarley@todo.todo>' to fix it.")
    endif()

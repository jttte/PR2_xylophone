...
if("TRUE" STREQUAL "TRUE")
  set(pickup_object_SOURCE_PREFIX /home/cl3295/robot-test/src/pickup_object)
  set(pickup_object_DEVEL_PREFIX /home/cl3295/robot-test/devel)
  ...
  set(pickup_object_INSTALL_PREFIX /home/cl3295/robot-test/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pickup_object' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'cl3295 <cl3295@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pickup_object' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cl3295/robot-test/src/pickup_object/${idir}'.  Ask the maintainer 'cl3295 <cl3295@todo.todo>' to fix it.")
    endif()

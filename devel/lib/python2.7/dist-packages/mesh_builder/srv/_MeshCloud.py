"""autogenerated by genpy from mesh_builder/MeshCloudRequest.msg. Do not edit."""
import sys
...
class MeshCloudRequest(genpy.Message):
  _md5sum = "93fc0f527b5d70da140d426da043ff09"
  _type = "mesh_builder/MeshCloudRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string output_filepath
...
"""
  __slots__ = ['output_filepath','input_cloud']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MeshCloudRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.input_cloud.header.seq, _x.input_cloud.header.stamp.secs, _x.input_cloud.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.input_cloud.height, _x.input_cloud.width))
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.input_cloud.is_bigendian, _x.input_cloud.point_step, _x.input_cloud.row_step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.input_cloud.is_dense))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.output_filepath = str[start:end].decode('utf-8')
      else:
        self.output_filepath = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.input_cloud.header.seq, _x.input_cloud.header.stamp.secs, _x.input_cloud.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.input_cloud.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.input_cloud.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.input_cloud.height, _x.input_cloud.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (_x.input_cloud.is_bigendian, _x.input_cloud.point_step, _x.input_cloud.row_step,) = _struct_B2I.unpack(str[start:end])
      ...
      (self.input_cloud.is_dense,) = _struct_B.unpack(str[start:end])
...
"""autogenerated by genpy from mesh_builder/MeshCloudResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MeshCloudResponse(genpy.Message):
  _md5sum = "7b1c59d2aff2f23de4aefee01de9f932"
  _type = "mesh_builder/MeshCloudResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string[] segmented_mesh_filenames
...
"""
  __slots__ = ['segmented_mesh_filenames','offsets','planning_scene']
  _slot_types = ['string[]','geometry_msgs/Vector3[]','moveit_msgs/PlanningScene']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       segmented_mesh_filenames,offsets,planning_scene
    ...
    """
    if args or kwds:
      super(MeshCloudResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.segmented_mesh_filenames is None:
        self.segmented_mesh_filenames = []
      if self.offsets is None:
        self.offsets = []
      if self.planning_scene is None:
        self.planning_scene = moveit_msgs.msg.PlanningScene()
    else:
      self.segmented_mesh_filenames = []
      self.offsets = []
      self.planning_scene = moveit_msgs.msg.PlanningScene()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.segmented_mesh_filenames)
      buff.write(_struct_I.pack(length))
      for val1 in self.segmented_mesh_filenames:
        length = len(val1)
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.planning_scene.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs))
      _x = self.planning_scene.robot_state.multi_dof_joint_state.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.planning_scene.robot_state.multi_dof_joint_state.joint_names:
        ...
        if python3 or type(val1) == unicode:
          ...
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.planning_scene.robot_state.multi_dof_joint_state.transforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.robot_state.multi_dof_joint_state.transforms:
      ...
      length = len(self.planning_scene.robot_state.multi_dof_joint_state.twist)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.robot_state.multi_dof_joint_state.twist:
        _v3 = val1.linear
        _x = _v3
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v4 = val1.angular
        _x = _v4
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      length = len(self.planning_scene.robot_state.multi_dof_joint_state.wrench)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.robot_state.multi_dof_joint_state.wrench:
        _v5 = val1.force
        _x = _v5
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v6 = val1.torque
        _x = _v6
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      length = len(self.planning_scene.robot_state.attached_collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.robot_state.attached_collision_objects:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      buff.write(_struct_B.pack(self.planning_scene.robot_state.is_diff))
      _x = self.planning_scene.robot_model_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      for val1 in self.planning_scene.fixed_frame_transforms:
        ...
        _x = _v25
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.planning_scene.allowed_collision_matrix.entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.allowed_collision_matrix.entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.planning_scene.allowed_collision_matrix.entry_values)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.allowed_collision_matrix.entry_values:
        length = len(val1.enabled)
        buff.write(_struct_I.pack(length))
        pattern = '<%sB'%length
        buff.write(struct.pack(pattern, *val1.enabled))
      length = len(self.planning_scene.allowed_collision_matrix.default_entry_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.allowed_collision_matrix.default_entry_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.planning_scene.allowed_collision_matrix.default_entry_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.planning_scene.allowed_collision_matrix.default_entry_values))
      ...
      length = len(self.planning_scene.link_scale)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.link_scale:
        _x = val1.link_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.planning_scene.object_colors)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.object_colors:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      length = len(self.planning_scene.world.collision_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.world.collision_objects:
        _v27 = val1.header
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.planning_scene.world.octomap.header.seq, _x.planning_scene.world.octomap.header.stamp.secs, _x.planning_scene.world.octomap.header.stamp.nsecs))
      _x = self.planning_scene.world.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.planning_scene.world.octomap.origin.position.x, _x.planning_scene.world.octomap.origin.position.y, _x.planning_scene.world.octomap.origin.position.z, _x.planning_scene.world.octomap.origin.orientation.x, _x.planning_scene.world.octomap.origin.orientation.y, _x.planning_scene.world.octomap.origin.orientation.z, _x.planning_scene.world.octomap.origin.orientation.w, _x.planning_scene.world.octomap.octomap.header.seq, _x.planning_scene.world.octomap.octomap.header.stamp.secs, _x.planning_scene.world.octomap.octomap.header.stamp.nsecs))
      _x = self.planning_scene.world.octomap.octomap.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.planning_scene.world.octomap.octomap.binary))
      _x = self.planning_scene.world.octomap.octomap.id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.planning_scene.world.octomap.octomap.resolution))
      length = len(self.planning_scene.world.octomap.octomap.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.planning_scene.world.octomap.octomap.data))
      buff.write(_struct_B.pack(self.planning_scene.is_diff))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.segmented_mesh_filenames.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.offsets = []
      ...
      if python3:
        self.planning_scene.name = str[start:end].decode('utf-8')
      else:
        self.planning_scene.name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.planning_scene.robot_state.multi_dof_joint_state.header.seq, _x.planning_scene.robot_state.multi_dof_joint_state.header.stamp.secs, _x.planning_scene.robot_state.multi_dof_joint_state.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.planning_scene.robot_state.multi_dof_joint_state.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.robot_state.multi_dof_joint_state.transforms = []
      for i in range(0, length):
        ...
        self.planning_scene.robot_state.multi_dof_joint_state.transforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.robot_state.multi_dof_joint_state.twist = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.planning_scene.robot_state.multi_dof_joint_state.twist.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.robot_state.multi_dof_joint_state.wrench = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        self.planning_scene.robot_state.multi_dof_joint_state.wrench.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.robot_state.attached_collision_objects = []
      for i in range(0, length):
        ...
        self.planning_scene.robot_state.attached_collision_objects.append(val1)
      start = end
      end += 1
      (self.planning_scene.robot_state.is_diff,) = _struct_B.unpack(str[start:end])
      self.planning_scene.robot_state.is_diff = bool(self.planning_scene.robot_state.is_diff)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene.robot_model_name = str[start:end].decode('utf-8')
      else:
        self.planning_scene.robot_model_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.allowed_collision_matrix.entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.planning_scene.allowed_collision_matrix.entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.allowed_collision_matrix.entry_values = []
      for i in range(0, length):
        ...
        self.planning_scene.allowed_collision_matrix.entry_values.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.allowed_collision_matrix.default_entry_names = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.planning_scene.allowed_collision_matrix.default_entry_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sB'%length
      ...
      self.planning_scene.allowed_collision_matrix.default_entry_values = struct.unpack(pattern, str[start:end])
      self.planning_scene.allowed_collision_matrix.default_entry_values = map(bool, self.planning_scene.allowed_collision_matrix.default_entry_values)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.link_scale = []
      for i in range(0, length):
        ...
        self.planning_scene.link_scale.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.planning_scene.object_colors = []
      for i in range(0, length):
        ...
        self.planning_scene.object_colors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.planning_scene.world.collision_objects.append(val1)
      _x = self
      start = end
      end += 12
      (_x.planning_scene.world.octomap.header.seq, _x.planning_scene.world.octomap.header.stamp.secs, _x.planning_scene.world.octomap.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene.world.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.planning_scene.world.octomap.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.planning_scene.world.octomap.origin.position.x, _x.planning_scene.world.octomap.origin.position.y, _x.planning_scene.world.octomap.origin.position.z, _x.planning_scene.world.octomap.origin.orientation.x, _x.planning_scene.world.octomap.origin.orientation.y, _x.planning_scene.world.octomap.origin.orientation.z, _x.planning_scene.world.octomap.origin.orientation.w, _x.planning_scene.world.octomap.octomap.header.seq, _x.planning_scene.world.octomap.octomap.header.stamp.secs, _x.planning_scene.world.octomap.octomap.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene.world.octomap.octomap.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.planning_scene.world.octomap.octomap.header.frame_id = str[start:end]
      start = end
      end += 1
      (self.planning_scene.world.octomap.octomap.binary,) = _struct_B.unpack(str[start:end])
      self.planning_scene.world.octomap.octomap.binary = bool(self.planning_scene.world.octomap.octomap.binary)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.planning_scene.world.octomap.octomap.id = str[start:end].decode('utf-8')
      else:
        self.planning_scene.world.octomap.octomap.id = str[start:end]
      start = end
      end += 8
      (self.planning_scene.world.octomap.octomap.resolution,) = _struct_d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sb'%length
      ...
      self.planning_scene.world.octomap.octomap.data = struct.unpack(pattern, str[start:end])
      start = end
      end += 1
      (self.planning_scene.is_diff,) = _struct_B.unpack(str[start:end])
      self.planning_scene.is_diff = bool(self.planning_scene.is_diff)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(self.planning_scene.allowed_collision_matrix.default_entry_values.tostring())
      length = len(self.planning_scene.link_padding)
      buff.write(_struct_I.pack(length))
      for val1 in self.planning_scene.link_padding:
        _x = val1.link_name
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(self.planning_scene.world.octomap.octomap.data.tostring())
      buff.write(_struct_B.pack(self.planning_scene.is_diff))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.planning_scene.allowed_collision_matrix.default_entry_values = numpy.frombuffer(str[start:end], dtype=numpy.bool, count=length)
      self.planning_scene.allowed_collision_matrix.default_entry_values = map(bool, self.planning_scene.allowed_collision_matrix.default_entry_values)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      self.planning_scene.world.octomap.octomap.data = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      start = end
      end += 1
      (self.planning_scene.is_diff,) = _struct_B.unpack(str[start:end])
      self.planning_scene.is_diff = bool(self.planning_scene.is_diff)
...
class MeshCloud(object):
  _type          = 'mesh_builder/MeshCloud'
  _md5sum = '57bb768f743be4bd0d6adcabc8b3a329'
  _request_class  = MeshCloudRequest
  _response_class = MeshCloudResponse

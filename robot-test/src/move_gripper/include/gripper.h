...
public:
  ...
  left_Gripper(ros::NodeHandle &nh){
    nh_ = nh;
  ...
  void close(){
    ...
    gripper_cmd.max_effort = 50000.0;
...
public:
  //Action client initialization
  right_Gripper(ros::NodeHandle &nh){
    nh_ = nh;
    l_gripper_ = nh_.advertise<pr2_controllers_msgs::Pr2GripperCommand>("/r_gripper_controller/command", 1);
  }

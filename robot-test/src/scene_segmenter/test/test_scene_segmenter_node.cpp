...
namespace scene_segmenter_node_test
{
    class TestSceneSegmenterNode
    {
        ...
        public:
            ...
            void sceneMessageCallback(const geometry_msgs::SegmentedObjectList::Pose msg);
    ...
    void TestSceneSegmenterNode::sceneMessageCallback(const geometry_msgs::SegmentedObjectList::Pose msg)
    {
